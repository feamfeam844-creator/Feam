...
token = "MTQ3Njk5NjIyMDk5OTMwMzM1OA.Gfabgm.v2urA9sXvDiSbQkiW22TSpaEqKMHb6YKQ9M2P8" # โทเค็นบอท
server = 1492961383409778820 # <--- ไอดีเซิร์ฟเวอร์ของเรา
spam_max = 100 # <--- จำนวนการยิงเบอร์สูงสุด
title_ui = "ลิงยิงเบอร์โหดที่สุด | บริการยิงเบอร์" # <--- ชื่อ Title ในที่กรอกเบอร์และจำนวน (Modal)
des = "ยิงเบอร์ฟรี" # ข้อความอธิบายในส่วนของ Embed
label = "ยิงตรงนี้" # ชื่อปุ่มกดยิงเบอร์
url = "xxxxxx" # <--- Url รูปภาพ
####################################################################
